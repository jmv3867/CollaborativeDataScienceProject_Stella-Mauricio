...
# --- 11d. Visualise as annotated heatmap ---
...
```{r}
# --- 12a. Layman metrics computed directly from posterior ellipse centroids ---
...
# --- 12c. Niche partitioning: group centroids in isotopic space ---
centroids <- bind_rows(
  humans %>%
...
# --- 13b. Compute f_C4 for each individual ---
# Apply the two-source mixing model to every individual in the dataset.
# Values outside [0,1] are clamped — these indicate the simple two-source
# model is not perfectly capturing the full dietary complexity, but they
# remain informative as relative indicators.
...
# --- 13e. Visualise maize contribution across groups ---
